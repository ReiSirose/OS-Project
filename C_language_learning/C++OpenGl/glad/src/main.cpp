...
constexpr char VERTEX_SHADER_PATH []= "../src/6.1.coordinate_systems.vert";
constexpr char FRAGMENT_SHADER_PATH [] = "../src/6.1.coordinate_systems.frag"; 
...
int main()
{
    ...
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
    // load image, create texture and generate mipmaps
    data = stbi_load(TEXTURE_FILE_PATH2, &width, &height, &nrChannels, 0);
    if (data)
    {
